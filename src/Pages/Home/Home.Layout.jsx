    ...
    return (
        <>
            <HomeNav $menuOpen={menuOpen}>
                ...
                <NavItem to='starred_message'><span></span><i class="fa-regular fa-star"></i><p>Starred Messages</p></NavItem>
                <NavItem to='archive'><span></span><i class="fa-solid fa-box-archive"></i><p>Archive</p></NavItem>
                <NavItem to='settings'><span></span><i class="fa-solid fa-gear"></i><p>Settings</p></NavItem>
                <NavItem to='profile'><span></span><i class="fa-solid fa-user"></i><p>Profile</p></NavItem>
